...
<div class="p-8">
        ...
        <form method="GET" action="{{ route('petugas.laporan.index') }}">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="flex items-end gap-2">
                    <button type="submit"
                        class="px-4 py-2 bg-linear-to-r from-indigo-500 to-blue-500 text-white rounded-xl shadow-md hover:opacity-90 transition">
                        Filter
                    </button>
    ...
    @if(request('bulan') || request('dari') || request('sampai'))
